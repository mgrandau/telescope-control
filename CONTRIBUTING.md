...
Welcome to `telescope-control` contributor's guide.
...
If you experience bugs or general issues with `telescope-control`, please have a look
...
You can help improve `telescope-control` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`telescope-control` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `telescope-control`'s files. While this mechanism can
...
```
conda create -n telescope-control python=3 six virtualenv pytest pytest-cov
conda activate telescope-control
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/telescope-control.git
...
5. Install [pre-commit]:
   ...
   `telescope-control` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/telescope-control
[issue tracker]: https://github.com/<USERNAME>/telescope-control/issues
